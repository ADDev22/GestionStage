...
import java.awt.event.ActionEvent;
	...
	public class EntrepriseModifOffre  extends JFrame {
		...
		public EntrepriseModifOffre(final EntrepriseController eCont) {
			...
			libelele = new JTextField(eCont.getOffreSelec().getLibelleOffre()); 
			...
			final JTextArea descripT = new JTextArea(eCont.getOffreSelec().getDescriptifOffre());
			...
			dureeT = new JTextField(eCont.getOffreSelec().getDureeOffre());
			panel_6.add(dureeT);
